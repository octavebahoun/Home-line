...
- **Appareils à haute consommation** : réfrigérateur, climatiseur, télévision, etc.  
- **Appareils ménagers** : robot aspirateur, machine à laver avec boutons pour ouvrir l’interface ou éteindre.  
- **Alimentation générale** : coupure/allumage complet de la maison.  
- Section CTA pour encourager à rejoindre le projet / l’équipe IOT.  
